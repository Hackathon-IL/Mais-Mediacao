      ...
      <ScrollView style={styles.contentContainer}>
        <View style={local_styles.contentContainer}>
          <View style={local_styles.labelContainer}>
            ...
            <Text style={[styles.mediumPrimaryText, local_styles.labelText]}>Imigrantes</Text>
          </View>
          <View style={styles.horizontalSeparator} />
          <Text style={[styles.tinyPrimaryText, local_styles.contentText]}>
        ...
        <View style={local_styles.contentContainer}>
          <View style={local_styles.labelContainer}>
            ...
            <Text style={[styles.mediumPrimaryText, local_styles.labelText]}>Indígenas</Text>
          </View>
          <View style={styles.horizontalSeparator} />
          <Text style={[styles.tinyPrimaryText, local_styles.contentText]}>
